...
public class MockFloodlightProvider implements IFloodlightModule, IFloodlightProviderService {
    ...
    private ConcurrentLinkedQueue<IControllerRollbackListener> rollbackListeners;
	...
	@Override
	public void addRollbackListener(IControllerRollbackListener listener) {
		
	}

	@Override
	public void removeRollbackListener(IControllerRollbackListener listener) {
		// TODO Auto-generated method stub
