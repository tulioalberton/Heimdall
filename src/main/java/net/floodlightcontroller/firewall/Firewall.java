...
IFloodlightModule {
	...
	protected ArrayList<FirewallRule> rules; // protected by synchronized
	...
	public void init(FloodlightModuleContext context) throws FloodlightModuleException {
		...
		//rules = new ArrayList<FirewallRule>();//original//moved to startUp
	...
	public void startUp(FloodlightModuleContext context) {
		...
		/*rules = tarService.createArrayListTracing(
				new ArrayList<FirewallRule>(), 
				"FW:rules",
				Scope.GLOBAL);*/
		//rules = tarService.createArrayListTracing(new ArrayList<FirewallRule>(), "FW:rules", Scope.GLOBAL);
	...
	@Override
	public synchronized void addRule(FirewallRule rule, boolean dispatchMemory) {
		...
		/**
		 * Changed to sequential one
		 */
		rule.ruleid = rule.incAndGetRuleId();
		//sequentially added
		this.rules.add(rule);
		...
		//if(dispatchMemory)
			//TracePacketIn.getInstance().dispatchMemoryChanges(1100000);
		logger.info("\n\n\n Dispatch Memory Changes NOW!");
	}
