...
public class PktInProcessingTime
    ...
    @Override
    public void increaseRollcabackCounter(){
    	ctb.incRollBackCounter();
    }
    ...
    @Override
	public void recordStartTimeDS() {
        if (isEnabled()) {
        	ctb.setStartTimeDSNs(System.nanoTime());
        }
        
	}

	@Override
	public void recordEndTimeDS() {
		if (isEnabled()) {
            ctb.setEndTimeDSNs(System.nanoTime() - ctb.getStartTimeDSNs());            
        }
	}

	@Override
	public long getTimeDS() {
		// TODO Auto-generated method stub
		return ctb.getEndTimeDSNs();
	}

	@Override
	public void increaseTotalPacketCounter() {
		ctb.incTotalPacketCounter();
	}
