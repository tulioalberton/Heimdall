...
public class CumulativeTimeBucket {
    ...
    private long startTimeDS_ns;
    private long endTimeDS_ns;
    
    public void setStartTimeDSNs(long ns) {
        startTimeDS_ns = ns;
    }
    public void setEndTimeDSNs( long ns) {
        endTimeDS_ns = ns;
    } 
    public long getStartTimeDSNs() {
        return startTimeDS_ns;
    }
    public long getEndTimeDSNs() {
        return endTimeDS_ns;
    }
    ...
    public long getTotalPktRollback() {
        return totalPktRollback;
    }
    ...
    public void incTotalPacketCounter(){
    	totalPktCnt++;
    }
