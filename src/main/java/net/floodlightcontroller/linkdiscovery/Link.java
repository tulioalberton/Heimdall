...
public class Link implements Comparable<Link> {
    ...
    public Link(
    		@JsonProperty("src-switch")DatapathId srcId, 
    		@JsonProperty("src-port")OFPort srcPort, 
    		@JsonProperty("dst-switch")DatapathId dstId, 
    		@JsonProperty("dst-port")OFPort dstPort, 
    		@JsonProperty("latency")U64 latency) {
        this.src = srcId;
    ...
    /*public Link(
    		@JsonProperty("src-switch")DatapathId src,
    		@JsonProperty("src-port")OFPort srcPort,
    		@JsonProperty("dst-switch")DatapathId dst,
    		@JsonProperty("dst-port")OFPort dstPort,
    		@JsonProperty("latency")U64 latency) {
