...
public interface IDeviceService extends IFloodlightService {
    ...
    /**
     * Heimdall
     * Used to recover info from ZooKeeper and populate deviceMap data structure. 
     */
    //public Device allocateDevice(Long deviceKey, Entity entity, IEntityClass entityClass);
    /*public Device allocateDevice(Long deviceKey, String dhcpClientName, List<AttachmentPoint> aps,
