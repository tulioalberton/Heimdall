...
public class ThreadPool implements IThreadPoolService, IFloodlightModule {
    ...
    public void init(FloodlightModuleContext context)
        ...
        Map<String, String> configParams = context.getConfigParams(ThreadPool.class);
		int threadPool = Integer.parseInt(configParams.get("cpuThreadPool"));
        ...
        executor = Executors.newScheduledThreadPool(threadPool, f);
    }
