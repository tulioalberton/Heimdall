...
implements IFloodlightModule, ILearningSwitchService, IOFMessageListener, IControllerCompletionListener {
	...
	protected MapTracing<IOFSwitch, Map<MacVlanPair, OFPort>> macVlanToSwitchPortMap;
	...
	Function<Map<IOFSwitch, Map<MacVlanPair, OFPort>>, String> serMap_IOFSwitchMacVlanPair = (info) -> {
		try {
	...
	Function<String, Map<IOFSwitch, Map<MacVlanPair, OFPort>>> desMap_IOFSwitchMacVlanPair = (String str) -> {
		try {
	...
	public void startUp(FloodlightModuleContext context) {
		...
		/*macVlanToSwitchPortMap = tarService.createMapTracing(
				new ConcurrentHashMap<IOFSwitch, Map<MacVlanPair, OFPort>>(),
				"LS:macVlanToSwitchPortMap",
				Scope.GLOBAL, 
				this,
				serMap_IOFSwitchMacVlanPair,
				desMap_IOFSwitchMacVlanPair);*/
